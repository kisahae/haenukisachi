...
function VerticalEducationTimeline(){
  const education = [
    ...
    },
    {
      ...
      description:"Robot Engineering (GPA:4.18/4.5), Course Taken: ICT Fusion Robotics, Game Programming Language, Japan and Global Community, Advanced English Writing, and Survival Korean Class.",
      height:"100%"
    },
    {
      img: asia_univ,
      ...
      description:"Virtual Exchange Student, Course Taken: Digital Image Processing and Data Science.",
      height:"100%"
    }
  ]
    return(
            ...
            <VerticalTimeline lineColor="#000">
              {
                education.map(function (value){
                  ...
                  icon={<img src={value.img} alt={value.alt} style={{backgroundColor:"white",height:`${value.height}`,margin:"auto"}}></img>}
                  date={value.date}
                >
