  ...
  const educationData = [
    {
      ...
      explanation:
        "Did some researches and maintained the web system using React JS, Storybook, Babel, Rollup, Tailwind CSS, Bitbucket, and Jira."
    },
    {
    ...
    },
    {
      ...
      subtitle: "Serpong, Tangerang Selatan",
      explanation:
        "Creating the simulation of fire alarm system for nuclear reactor using C++, LabVIEW, and Proteus."
    }
  ]
  return (
    <div>
          ...
          {educationData.map(function (value) {
            return (
              <VerticalTimelineElement
                ...
                contentArrowStyle={{
                  borderRight: "7px solid  rgb(25, 26, 28)"
                }}
                date={value.date}
